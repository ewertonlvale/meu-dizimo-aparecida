...
| BL-74 | Sair do Apps Script: fila, estado em Redis, CI e monitoramento | 🟠 | GG | 🔶 **Fases 0, 1 e 2 no ar (25/09)** — runtime Node no Cloud Run, sem tráfego, provado com Odoo, Upstash e WhatsApp reais. Próxima: Fase 3 (fila e trava por usuário). Plano em `MIGRACAO-NIVEL-1.md` |
